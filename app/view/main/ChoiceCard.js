/**
 * Creates class pmdCE.view.main.ChoiceCard that extend from Ext.panel.Panel.
 * @class
 * @classdesc pmdCE.view.main.ChoiceCard is a help class for create 
 * two cards for 'create'- and 'change to...'-dialogs.
 */
Ext.define('pmdCE.view.main.ChoiceCard', {
