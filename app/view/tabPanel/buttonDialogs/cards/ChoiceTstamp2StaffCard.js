/**
 * Creates class pmdCE.view.tabPanel.buttonDialogs.cards.ChoiceTstamp2StaffCard that extend from pmdCE.view.tabPanel.buttonDialogs.cards.ChoiceCard.
 * @class
 * @classdesc pmdCE.view.tabPanel.buttonDialogs.cards.ChoiceTstamp2StaffCard is class for create
 ...
 */
Ext.define('pmdCE.view.tabPanel.buttonDialogs.cards.ChoiceTstamp2StaffCard', {
	...
	initComponent: function () {
		...
		if (Ext.getCmp('cemain').getCard() === 13) {
			if (Ext.getCmp('cemain').getComponentType().indexOf('Hairpin') > -1) {
