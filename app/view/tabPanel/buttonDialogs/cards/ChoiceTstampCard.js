/**
 * Creates class pmdCE.view.tabPanel.buttonDialogs.cards.ChoiceTstampCard that extend from pmdCE.view.tabPanel.buttonDialogs.cards.ChoiceCard.
 * @class
 * @classdesc pmdCE.view.tabPanel.buttonDialogs.cards.ChoiceTstampCard is class for create
 ...
 */
Ext.define('pmdCE.view.tabPanel.buttonDialogs.cards.ChoiceTstampCard', {
	...
	initComponent: function () {
		...
		if (Ext.getCmp('cemain').getCard() === 8) {
			if (Ext.getCmp('cemain').getComponentType().indexOf('Hairpin') > -1) {
	...
	handleCreateButton: function () {
		if (placeField.isValid() && formField.isValid() && tstampFieldOrig.isValid() && tstamp2FieldOrig.isValid() && tstampFieldReg1.isValid() && tstampFieldReg2.isValid() && tstamp2FieldReg1.isValid() && tstamp2FieldReg2.isValid()) {
	...
	/**
	 * Handle function for set value in tstamp2- or form- fields in regs.
	 */
